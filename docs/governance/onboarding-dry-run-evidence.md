...
- `docs/governance/dockerfile-baseline-evidence.md`
- `docs/governance/local-compose-stack-evidence.md`
- `docs/governance/local-smoke-test-evidence.md`
- `docs/governance/local-data-bootstrap-evidence.md`
- `docs/governance/toolchain-bootstrap-evidence.md`
